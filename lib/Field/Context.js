...
import { fieldStatus, fieldStatusChange } from '../Status.js'
//import { sleep } from '../Utils.js'

class FieldContext extends BaseContext {
  // static initialState = { status: defaultStatus }
  static statusChange = fieldStatusChange
  static debug        = false
  ...
  newStatus(status) {
    return isString(status)
      ? (this.constructor.statusChange(this.props)[status] || { [status]: true })
      : status
  }
  constructor(props) {
    super(props)
  ...
  onBlur() {
    this.setBlurState(
      { },
      this.state.validateOnBlur     // TODO: this.props...
  ...
  onChange(input) {
    ...
    const {
      // TODO
      validateOnChange=fieldDefaultProperties.validateOnChange,
      validateOnInvalid=fieldDefaultProperties.validateOnInvalid,
      minValidateLength=fieldDefaultProperties.minValidateLength
    } = this.state  // TODO: this.props
