...
import {
  FieldLink, FormFieldsLink, FormLink, MinValidateLengthLink, NameLink,
...
const FieldValidation = () =>
  <div className="prose">
    ...
    <Split>
      <div>
        <p>
          You can add a <ValidateLink/> property to a field to provide a
        ...
        <p>
          You can add the <ValidateLink/> function to the <FieldLink/>{' '}
          ...
          component as the <FormFieldsLink/> property.  When you include
          a <FieldLink/> the <NameLink/> will be used to lookup the default
          properties for the field from the <FormFieldsLink/> you&apos;ve
          provided.
        </p>
      </div>
      <div>
    ...
    <dl>
      ...
      <dd>
        <p>
          ...
          You can add the <ValidateOnBlurLink/> property to either the{' '}
      ...
      <dd>
        <p>
          You can add the <ValidateOnChangeLink/> property to either the{' '}
      ...
      <dd>
        <p>
          The <MinValidateLengthLink/> can be set if you only want validation to
