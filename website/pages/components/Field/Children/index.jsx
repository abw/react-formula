...
import FunctionsSrc from './Functions.jsx?raw'
import Functions    from './Functions.jsx'
import { LayoutLink } from '../../../../site/Links.jsx'
...
const Children = () =>
  <div>
    ...
    <p>
      ...
      replace the default <LayoutLink/> component.  In this case it&apos;s
      up to you to render the field content.
    </p>
    <p>
      If you want to include the default layout for a field and add
      some content of your own then you can include the <LayoutLink/> component
      manually.
    </p>
    <Example
