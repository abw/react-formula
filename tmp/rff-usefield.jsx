...
import { FieldSubscription, FieldState, FormApi, FormValuesShape } from "final-form";
import { UseFieldConfig, FieldInputProps, FieldRenderProps, } from "./types";
...
function useField( name, config ) {
  const {
    afterSubmit, allowNull, component, data, defaultValue,
    format = defaultFormat,
    formatOnBlur, initialValue, multiple,
    parse = defaultParse,
    subscription = all,
  ...
  const register = (callback, silent) =>
