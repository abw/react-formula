import{j as n,a as e,D as a,ar as b,P as B,aC as E,L as l,aD as R,s as q,aE as y,F as w,c as p,G as D,aF as N,E as S,S as k,d as I,aG as V,_ as W,$ as c}from"./index-d33ecaeb.js";const $=(r="formula")=>({formula:r,bare:`${r}--bare`,checkbox:`${r}--checkbox`,checked:`${r}--checked`,controls:`${r}--controls`,debug:`${r}--debug`,disabled:`${r}--disabled`,errors:`${r}--errors`,field:`${r}--field`,fluid:`${r}--fluid`,focus:`${r}--focus`,help:`${r}--help`,inline:`${r}--inline`,input:`${r}--input`,invalid:`${r}--invalid`,option:`${r}--option`,optional:`${r}--optional`,panel:`${r}--panel`,prefix:`${r}--prefix`,prefixed:`${r}--prefixed`,radio:`${r}--radio`,required:`${r}--required`,suffix:`${r}--suffix`,suffixed:`${r}--suffixed`,valid:`${r}--valid`,wide:`${r}--wide`}),z=$(),M="import '@abw/react-formula/styles/formula.css'",H=`$brand-hue:   123;
$valid-hue:   40;
$invalid-hue: 12;
@import '@abw/react-formula/styles/formula.scss';`,O=`.formula {
  --brand-hue: 123;
}`,P=`@import '@abw/react-formula/styles/formula.scss';
...
.branded-maroon .formula {
  --brand-hue: 320;
}`,h=({color:r})=>e("div",{className:`branded-${r}`,children:n(w,{children:[e(p,{name:"field1",label:`The ${r} field`,placeholder:`The ${r} placeholder`}),e(D,{})]})}),X=()=>n("div",{className:"wide-border lg-grid-3",children:[e(h,{color:"red"}),e(h,{color:"orange"}),e(h,{color:"yellow"}),e(h,{color:"green"}),e(h,{color:"teal"}),e(h,{color:"blue"}),e(h,{color:"indigo"}),e(h,{color:"violet"}),e(h,{color:"maroon"})]}),Z=`import { Form, Field, ResetSubmit } from '../../../../lib/index.js'
...
`,Re='<button type="submit" class="submit">Submit</button>',qe='<button type="reset" class="reset">Reset</button>',De='<button type="button" class="cancel">Cancel</button>',Ne=`<div class="controls">
...
}`,Le=T(Ae),Ye=()=>n("div",{children:[e("h1",{children:"CSS Variables - Dark Mode"}),n("p",{className:"intro",children:["These are the modified values that override the"," ",e(b,{to:"/styling/css-defaults",text:"default CSS variable values"})," ","in dark mode."]}),e(m,{vars:Le}),e(f,{uri:"css-dark"})]}),Ge=()=>n(W,{children:[e(c,{path:"",exact:!0,element:e(A,{})}),e(c,{path:"forms",element:e(L,{})}),e(c,{path:"fields",element:e(Y,{})}),e(c,{path:"css-classes",element:e(se,{})}),e(c,{path:"css-variables",element:e(ne,{})}),e(c,{path:"css-defaults",element:e(Pe,{})}),e(c,{path:"css-dark",element:e(Ye,{})}),e(c,{path:"sass-variables",element:e(K,{})}),e(c,{path:"markup",element:e(Me,{})})]});export{Ge as default};
