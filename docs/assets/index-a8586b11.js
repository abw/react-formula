...
export default SubmitThrow`,Ye=()=>e(g,{children:t(o,{onSubmit:()=>{throw new Error("Oh noes! An error occurred")},debug:!0,children:[e(E,{}),e(i,{name:"email",label:"Email Address",required:!0}),e(i,{name:"password",type:"password",label:"Password",required:!0}),e(l,{text:"Login"})]})}),Be=`import { Form, Field, Submit, Errors } from '../../../../lib/index.js'
...
export default SubmitThrow`,De=()=>e(g,{children:t(o,{onSubmit:()=>Promise.reject({errors:[{name:"email",message:"Your email address is not valid"},{name:"password",message:"Your password is too easy to guess"}]}),children:[e(E,{}),e(i,{name:"email",label:"Email Address",required:!0,debug:!0}),e(i,{name:"password",type:"password",label:"Password",required:!0}),e(l,{text:"Login"})]})}),Ie=`import { Form, Field, Submit, Errors } from '../../../../lib/index.js'
...
export default HeadlessBlank`,dt={email:{label:"Email Address",required:!0}},ct=()=>t(o,{fields:dt,children:[e(i,{name:"email",children:r=>t(O,{children:[t("h2",{className:"mar-t-none",children:["Custom Layout for ",r.name]}),e(H,{}),e(V,{}),e($,{})]})}),e(l,{text:"Login"})]}),mt=`import {
...
export default HeadlessBuiltins`,ut={email:{label:"Email Address",required:!0}},ht=()=>t(o,{fields:ut,children:[e(i,{name:"email",children:t(O,{children:[e("h2",{className:"mar-t-none",children:"Custom Layout for Email field"}),e(H,{}),e(V,{}),e($,{})]})}),e(l,{text:"Login"})]}),pt=`import {
  Form, Field, Layout, Label, Text, Message, Submit
} from '../../../../lib/index.js'
