...
export default BrandedForms`,O=`.formula {
  ...
  --valid-border:       #4a4;
  --invalid-border:     #4a4;
}`;const q=()=>{const{isDark:l,toggleTheme:c}=F();return n("div",{children:[e("h1",{children:"CSS Variables"}),n("p",{className:"intro",children:["The CSS file makes heavy use of CSS variable (also known as ",e("i",{children:"CSS Custom Properties"}),") for styling."]}),e("h2",{children:"Redefining Variables"}),n("p",{children:["To change the styling you simply need to define a ",e("code",{children:".formula"})," ","block in your CSS file with the new variable definitions."]}),e(o,{language:"css",code:O,caption:"your-stylesheet.css",expand:!0}),n("p",{children:["The ",e("code",{children:"--brand-hue"})," CSS variable defines the default hue for field input and other elements.  You can easily set this to match your site branding. Here's an extract of CSS which sets it to 9 different colors. We're also increasing the width of the border and focus ring to make it a bit more prominent."]}),e(o,{language:"css",code:z}),e("p",{children:"Here's the same form rendered 9 times inside each of those CSS scopes."}),e(C,{Element:E,code:B,caption:"Branded Forms",children:n("p",{children:["Try clicking on the fields to see the different colored focus rings.  Don't forget to check it out in"," ",n("span",{onClick:c,className:"link",children:[l?"light":"dark"," mode"]})," ","too!"]})}),n("p",{children:["If for some reason you need to change the CSS class names that are used (e.g. to change ",e("code",{children:".formula"})," to ",e("code",{children:".my-formula"}),") then you can do that by creating your own version of the CSS stylesheet from the SASS sources.  The class names and a number of other core properties are defined as "," ",e(f,{to:"/styling/sass-variables",text:"SASS variables"}),"."]})]})},L=()=>n(k,{children:[e(h,{path:"",exact:!0,element:e(T,{})}),e(h,{path:"forms",element:e(W,{})}),e(h,{path:"fields",element:e(D,{})}),e(h,{path:"css-variables",element:e(q,{})}),e(h,{path:"sass-variables",element:e(A,{})})]});export{L as default};
