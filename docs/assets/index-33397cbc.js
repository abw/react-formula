...
export default OnSuccessExample`,Be=()=>t("div",{children:[e("h1",{children:"Form Events"}),e("h2",{children:e("code",{children:"onSuccess"})}),e("p",{children:"TODO"}),e(r,{Element:je,code:Ye,caption:"onSuccess",expand:!0,children:e("p",{children:"TODO"})}),e(s,{links:["form:onSubmit","form:onError"]})]}),$e=()=>{const[o,a]=p.useState();return t(n,{onSubmit:d=>a(`foo was submitted as ${d.foo}`),children:[e(l,{name:"foo",label:"Foo Field"}),e(h,{}),o]})},Ie=`import { Form, Field, Submit } from '../../../../../lib/index.js'
...
export default OnErrorExample`,Me=()=>t("div",{children:[e("h1",{children:"Form Events"}),e("h2",{children:e("code",{children:"onError"})}),e("p",{children:"TODO"}),e(r,{Element:$e,code:Ie,caption:"onError",expand:!0,children:e("p",{children:"TODO"})}),e(s,{links:["form:onSubmit","form:onError"]})]}),Ue=`import { Form, Field } from '../../../../../../lib/index.js'
...
export default SetFocusExample`,$t=()=>{const[o,a]=p.useState(!1),[d,c]=p.useState(!1);return t(b,{children:[t(n,{children:[e(l,{onLoad:a,name:"field1",label:"Field One"}),e(l,{onLoad:c,name:"field2",label:"Field Two"})]}),t("div",{children:[e("button",{onClick:()=>o==null?void 0:o.setFocus(),children:"Focus Field One"}),e("button",{onClick:()=>d==null?void 0:d.setFocus(),children:"Focus Field Two"})]})]})},It=()=>t("div",{children:[e("h1",{children:"Field Functions"}),e("h2",{children:e("code",{children:"setFocus()"})}),t("p",{children:["If you want to programmatically set the focus on a ",e(m,{})," then you first need to capture a reference to it.  You can do that using an ",e("code",{children:"onLoad"})," property to set a state variable."]}),t("p",{children:["Then call the ",e("code",{children:"setFocus()"})," method on the field object to focus it."]}),e(r,{Element:$t,code:Bt,caption:"setFocus()",children:e("p",{children:"Click on one of the buttons to focus on a field."})}),t("p",{children:["You can also focus on fields by name using the ",e(u,{})," ",e(ne,{})," method."]}),e(s,{links:["form:setFocus","field:onFocus","field:onBlur"]})]}),Mt=`import { Form, Field } from '../../../../../lib/index.js'
...
export default ValidateExample`,Jl=()=>t("div",{children:[e("h1",{children:"Field Validation"}),e("h2",{children:e("code",{children:"validateOnBlur"})}),t("p",{children:["The ",e("code",{children:"validateOnBlur"})," property can be set to trigger validation whenever a field is blurred.  You can set it on individual"," ",e(m,{})," components or on the parent ",e(u,{})," to have it apply to all fields."]}),e(r,{Element:Wl,code:Kl,caption:"validate",children:e("p",{children:"Try switching focus from one field to another without entering anything.  You should see the custom validation errors when each field is blurred."})}),e(s,{links:["field:required","field:validate","field:validateOnChange"]})]}),zl=()=>t(O,{children:[e(i,{path:"",end:!0,element:e(_e,{})}),e(i,{path:"properties",element:e(et,{})}),e(i,{path:"name",element:e(it,{})}),e(i,{path:"label",element:e(ut,{})}),e(i,{path:"type",element:e(xt,{})}),e(i,{path:"placeholder",element:e(St,{})}),e(i,{path:"help",element:e(yt,{})}),e(i,{path:"prefix",element:e(Ct,{})}),e(i,{path:"suffix",element:e(At,{})}),e(i,{path:"required",element:e(ml,{})}),e(i,{path:"showRequired",element:e(bl,{})}),e(i,{path:"requiredLabel",element:e(El,{})}),e(i,{path:"requiredMessage",element:e(wl,{})}),e(i,{path:"showOptional",element:e(Ll,{})}),e(i,{path:"optionalLabel",element:e(Nl,{})}),e(i,{path:"prepareValue",element:e(dl,{})}),e(i,{path:"validate",element:e($l,{})}),e(i,{path:"validateOnBlur",element:e(Jl,{})}),e(i,{path:"validateOnChange",element:e(Hl,{})}),e(i,{path:"minValidateLength",element:e(Cl,{})}),e(i,{path:"onFocus",element:e(Pt,{})}),e(i,{path:"onBlur",element:e(Yt,{})}),e(i,{path:"onChange",element:e(Zt,{})}),e(i,{path:"onValid",element:e(tl,{})}),e(i,{path:"onInvalid",element:e(rl,{})}),e(i,{path:"setFocus",element:e(It,{})}),e(i,{path:"setValue",element:e(Wt,{})}),e(i,{path:"Reset",element:e(zt,{})})]}),Ql={name:{label:"Enter your name",placeholder:"Your name"},message:{label:"Enter a message",placeholder:"Hello World"},badgers:{label:"Do you like badgers?",type:"checkbox",text:"Yes, of course I do"},animal:{label:"What is your favourite animal?",type:"radio",options:["Badger","Ferret","Stoat"]}},Xl=()=>e(n,{fields:Ql,children:t("div",{className:"grid-2 gap-2",children:[e(T,{names:["name","message"]}),e(T,{names:"badgers animal"})]})}),Zl=`import { Form, Fields } from '../../../../../lib/index.js'
...
export default CancelExample`,vo=()=>t(n,{children:[e(l,{name:"field1",label:"Field One"}),e(M,{text:"Go Back",className:"btn-brown",onClick:()=>alert("Cancel button was clicked")})]}),yo=`import { Form, Field, Cancel } from '../../../../../lib/index.js'
...
export default CancelSubmitExample`,ko=()=>t(n,{onSubmit:()=>alert("You submitted the form"),children:[e(l,{name:"field1",label:"Field One"}),e(U,{className:"flex evenly",submit:{text:"Submit the Form",className:"wide btn-green"},cancel:{text:"Go Back",className:"wide btn-lilac",onClick:()=>alert("You went back")}})]}),Oo=`import { Form, Field, CancelSubmit } from '../../../../../lib/index.js'
...
export default CancelResetSubmitExample`,No=()=>t(n,{onSubmit:()=>alert("You submitted the form"),children:[e(l,{name:"field1",label:"Field One"}),e(H,{submit:{text:"Submit the Form",className:"btn-green"},reset:{text:"Reset the Form",className:"btn-brown"},cancel:{text:"Go Back",onClick:()=>alert("You went back")}})]}),Vo=`import { Form, Field, CancelResetSubmit } from '../../../../../lib/index.js'
...
export default ChangedExample`,Uo=()=>t("div",{children:[e("h1",{children:"Changed"}),t("p",{children:["The ",e("code",{children:"Changed"})," component will only render its child components when the form state has changed."]}),e("p",{children:'A typical example is shown below.  The "Reset" and "Submit" buttons are only displayed once the user has made changes to a form field.'}),e(r,{Element:Io,code:Mo,caption:"Changed",expand:!0,children:t("p",{children:["Edit one of the fields in the form and you should see the"," ",'"Reset" and "Submit" buttons appear as if by magic.  Try clicking on the "Reset" button and they will be hidden again.']})})]}),Ho=()=>t(n,{showRequired:!0,children:[e(l,{name:"one",label:"Field one",required:!0}),e(l,{name:"two",label:"Field two",required:!0}),e(l,{name:"three",label:"Field three"}),e(h,{})]}),Go=`import { Form, Field, Submit } from '../../../../../lib/index.js'
...
export default RequiredExample`,Wo=()=>t(n,{showRequired:!0,errorsInHeader:!1,children:[e(l,{name:"one",label:"Field one",required:!0}),e(l,{name:"two",label:"Field two",required:!0}),e(l,{name:"three",label:"Field three"}),e(Fe,{}),e(h,{})]}),Ko=`import { Form, Field, Errors, Submit } from '../../../../../lib/index.js'
...
export default LayoutExample`,cr=()=>e(n,{children:e(l,{name:"field1",label:"Field One",help:"A help message",children:t(A,{children:[e(N,{}),"Hello...",e(V,{}),"...World!",e(G,{})]})})}),mr=`import { Form, Field, Layout, Label, Text, Message } from '../../../../lib/index.js'
...
export default LayoutExample`,ur=()=>t("div",{children:[e("h1",{children:"Layout"}),t("p",{children:["The ",e("code",{children:"Layout"})," component provides the default content for a"," ",e(m,{}),".  It renders a ",e("code",{children:"div"})," with the ",e("code",{children:"field"})," ","CSS class and any other classes relevant to the state of the field (e.g. ",e("code",{children:"focus"}),", ",e("code",{children:"valid"})," and/or ",e("code",{children:"invalid"}),")."]}),t("p",{children:["If you're defining your own field content and want to include all the usual elements then you can manually include it in a ",e(m,{}),"."]}),e(r,{Element:dr,code:sr,caption:"Layout",expand:!0}),t("p",{children:["The ",e("code",{children:"Layout"})," component renders a ",e(xe,{}),", one of the relevant ",e(x,{to:"/inputs",text:"input type components"})," based on the ",e(Ee,{})," of the field, and the ",e(ge,{})," component."]}),t("p",{children:["You can manually include these inside a ",e(m,{})," and intersperse them with your own content."]}),e(r,{Element:cr,code:mr,caption:"Layout Content",expand:!0})]}),hr=()=>e(n,{children:e(l,{name:"field1",label:"Field One",children:t("div",{className:"field",children:[e(N,{}),e(V,{})]})})}),pr=`import { Form, Field, Text, Label } from '../../../../lib/index.js'
...
export default LabelExample`,fr=()=>t("div",{children:[e("h1",{children:"Label"}),t("p",{children:["The ",e("code",{children:"Label"})," component can be used to add a label to a"," ",e(m,{}),". It's usually added automatically, but it's useful if you're implementing your own layout for a field."]}),e(r,{Element:hr,code:pr,caption:"Label",expand:!0})]}),br=()=>t(n,{children:[e(l,{name:"field1",label:"Field One",help:"Additional help message",validMessage:"This is fine!",requiredMessage:"You must enter a value",required:!0,children:t(A,{children:[e(N,{}),e(V,{}),e(G,{})]})}),e(h,{})]}),Fr=`import { Form, Field, Layout, Label, Text, Message, Submit } from '../../../../lib/index.js'
...
export default MessageExample`,xr=()=>t("div",{children:[e("h1",{children:"Message"}),t("p",{children:["The ",e("code",{children:"Message"})," component is used to add a message underneath a ",e(m,{}),". It's usually added automatically, but it's useful if you're implementing your own layout for a field."]}),t("p",{children:["If you have defined ",e("code",{children:"help"})," for your field then it will be displayed here.  If the field fails to validate then the validation error message will be displayed.  In this example we're setting an explicit ",e("code",{children:"requiredMessage"})," to override the default message. We're also setting a ",e("code",{children:"validMessage"})," to provide a custom message if the field is valid."]}),e(r,{Element:br,code:Fr,caption:"Message",expand:!0})]}),Sr=()=>t(O,{children:[e(i,{path:"",end:!0,element:e(Se,{})}),e(i,{path:"Form/*",element:e(Qe,{})}),e(i,{path:"Field/*",element:e(zl,{})}),e(i,{path:"Fields",element:e(_l,{})}),e(i,{path:"Fieldset",element:e(no,{})}),e(i,{path:"Submit",element:e(ho,{})}),e(i,{path:"Reset",element:e(go,{})}),e(i,{path:"Cancel",element:e(To,{})}),e(i,{path:"CancelSubmit",element:e(Lo,{})}),e(i,{path:"ResetSubmit",element:e($o,{})}),e(i,{path:"CancelResetSubmit",element:e(Po,{})}),e(i,{path:"Changed",element:e(Uo,{})}),e(i,{path:"Errors",element:e(er,{})}),e(i,{path:"Debug",element:e(ar,{})}),e(i,{path:"Layout",element:e(ur,{})}),e(i,{path:"Label",element:e(fr,{})}),e(i,{path:"Message",element:e(xr,{})})]});export{Sr as default};
