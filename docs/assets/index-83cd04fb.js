import{j as t,a as e,T as g,F as s,b as r,S as d,L as $,c as m,d as l,e as T,N as y,f as M,R as E,g as F,V as k,h as L,i as J,k as U,M as z,l as h,m as G,n as C,r as w,o as v,p as Y,q as K,E as Q,s as R,t as P,u as X,v as Z,C as _,w as ee,x as te,y as ie,O as re,z as ae,A as I,D as B,B as oe,G as se,H as x,I as j,J as D,K as W,P as O,Q as ne,U as le,W as de,X as ce,Y as ue,Z as c}from"./index-c1991429.js";import{T as me}from"./TOC-90d5af65.js";import{E as o}from"./Example-5caf2141.js";import{c as b}from"./index.esm-ecaef62f.js";const he=()=>t("div",{children:[e("h1",{children:"Tutorial"}),e("p",{children:"This section of the documentation provides a guided walk-through of the features to get you up and running as quickly as possible."}),e(me,{menu:g,url:"/tutorial"})]}),pe=()=>t(s,{children:[e("h2",{children:"Login"}),e(r,{name:"email",label:"Email Address",required:!0}),e(r,{name:"password",type:"password",label:"Password",required:!0}),t("div",{className:"flex space",children:[e("a",{href:"https://tinyurl.com/576m4j6n",children:"Forgot your password?"}),e(d,{text:"Login"})]})]}),fe=`import { Form, Field, Submit } from '../../../../lib/index.js'
...
export default SubmitThrow`,Be=()=>e(v,{children:t(s,{onSubmit:()=>Promise.reject({errors:[{name:"email",message:"Your email address is not valid"},{name:"password",message:"Your password is too easy to guess"}]}),children:[e(r,{name:"email",label:"Email Address",required:!0,debug:!0}),e(r,{name:"password",type:"password",label:"Password",required:!0}),e(d,{text:"Login"})]})}),je=`import { Form, Field, Submit } from '../../../../lib/index.js'
...
export default HeadlessBlank`,dt={email:{label:"Email Address",required:!0}},ct=()=>t(s,{fields:dt,children:[e(r,{name:"email",children:i=>t(j,{children:[t("h2",{children:["Custom Layout for ",i.name]}),e(D,{}),e(W,{}),e(O,{})]})}),e(d,{text:"Login"})]}),ut=`import {
...
export default HeadlessBuiltins`,mt={email:{label:"Email Address",required:!0}},ht=()=>t(s,{fields:mt,children:[e(r,{name:"email",children:t(j,{children:[e("h2",{children:"Custom Layout for Email field"}),e(D,{}),e(W,{}),e(O,{})]})}),e(d,{text:"Login"})]}),pt=`import {
  Form, Field, Layout, Label, Text, Message, Submit
} from '../../../../lib/index.js'
