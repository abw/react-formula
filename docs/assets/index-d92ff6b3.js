import{j as n,a as e,D as a,a2 as b,P as B,ay as R,L as l,az as q,p as E,aA as y,F as w,c as p,G as D,aB as N,E as S,S as k,d as I,aC as V,_ as W,$ as c}from"./index-c469f383.js";const $=(r="formula")=>({formula:r,bare:`${r}--bare`,checkbox:`${r}--checkbox`,checked:`${r}--checked`,controls:`${r}--controls`,debug:`${r}--debug`,disabled:`${r}--disabled`,errors:`${r}--errors`,field:`${r}--field`,fluid:`${r}--fluid`,focus:`${r}--focus`,help:`${r}--help`,inline:`${r}--inline`,input:`${r}--input`,invalid:`${r}--invalid`,option:`${r}--option`,optional:`${r}--optional`,panel:`${r}--panel`,prefix:`${r}--prefix`,prefixed:`${r}--prefixed`,radio:`${r}--radio`,required:`${r}--required`,suffix:`${r}--suffix`,suffixed:`${r}--suffixed`,valid:`${r}--valid`,wide:`${r}--wide`}),z=$(),M="import '@abw/react-formula/styles/formula.css'",H=`$brand-hue:   123;
$valid-hue:   40;
$invalid-hue: 12;
