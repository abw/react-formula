...
export default SubmitExample`,fT=()=>c("div",{children:[o("h1",{children:"Validation"}),o("p",{children:"Validation can be applied on two levels: on individual fields and/or on the form."}),c("p",{children:["You can specify a field is ",o("code",{children:"required"}),", as shown here, or define your own custom ",o(te,{to:"/components/field/validation",text:"field validation"})," functions. When the form is submitted, each field will be validated.  If any validation errors occur then the form submission will be cancelled and the errors displayed."]}),o(_,{Element:dT,code:hT,caption:"Required Fields",children:o("p",{children:"Try entering some text in the fields below then click on the Submit button.  The first two fields are required so you can leave either of the them empty to see the validation errors."})}),c("p",{children:["You can also define a ",o("code",{children:"validate"})," function on the ",o(ae,{}),". This will be run after any field validation and will be passed"]})]}),mT=`import { Form, Field } from '../../../../../../lib/index.js'
