import{j as n,a as e,B as f,ar as S,a1 as c,as as w,L as a,at as y,p as k,F as C,c as $,D as B,au as T,E as F,_ as z,$ as h}from"./index-91eed579.js";const D=`$brand-hue:   123;
$valid-hue:   40;
$invalid-hue: 12;
...
}`,U=x(Q),X=()=>n("div",{children:[e("h1",{children:"CSS Variables - Dark Mode"}),n("p",{className:"intro",children:["These are the modified values that override the"," ",e(c,{to:"/styling/css-defaults",text:"default CSS variable values"})," ","in dark mode."]}),e(g,{vars:U})]}),ee=()=>n(z,{children:[e(h,{path:"",exact:!0,element:e(W,{})}),e(h,{path:"forms",element:e(N,{})}),e(h,{path:"fields",element:e(q,{})}),e(h,{path:"css-variables",element:e(J,{})}),e(h,{path:"css-defaults",element:e(K,{})}),e(h,{path:"css-dark",element:e(X,{})}),e(h,{path:"sass-variables",element:e(A,{})})]});export{ee as default};
