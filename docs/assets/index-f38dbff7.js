...
export default MessageExample`,xr=()=>t("div",{children:[e("h1",{children:"Message"}),t("p",{children:["The ",e("code",{children:"Message"})," component is used to add a message underneath a ",e(m,{}),". It's usually added automatically, but it's useful if you're implementing your own layout for a field."]}),t("p",{children:["If you have defined ",e("code",{children:"help"})," for your field then it will be displayed here.  If the field fails to validate then the validation error message will be displayed.  In this example we're setting an explicit ",e("code",{children:"requiredMessage"})," to override the default message. We're also setting a ",e("code",{children:"validMessage"})," to provide a custom message if the field is valid."]}),e(r,{Element:br,code:Fr,caption:"Message",expand:!0})]}),wr=()=>t(O,{children:[e(i,{path:"",end:!0,element:e(Se,{})}),e(i,{path:"Form/*",element:e(Xe,{})}),e(i,{path:"Field/*",element:e(zl,{})}),e(i,{path:"Fields",element:e(Ql,{})}),e(i,{path:"Fieldset",element:e(no,{})}),e(i,{path:"Submit",element:e(ho,{})}),e(i,{path:"Reset",element:e(go,{})}),e(i,{path:"Cancel",element:e(To,{})}),e(i,{path:"CancelSubmit",element:e(Lo,{})}),e(i,{path:"ResetSubmit",element:e(Io,{})}),e(i,{path:"CancelResetSubmit",element:e(Po,{})}),e(i,{path:"Changed",element:e(Uo,{})}),e(i,{path:"Errors",element:e(er,{})}),e(i,{path:"Debug",element:e(ar,{})}),e(i,{path:"Layout",element:e(ur,{})}),e(i,{path:"Label",element:e(fr,{})}),e(i,{path:"Message",element:e(xr,{})})]});export{wr as default};
