import{j as t,a as e,ai as n,F as l,b as a,o as c,S as d,c as i,Y as s,Z as r}from"./index-fef9bd09.js";import{T as m}from"./TOC-842cc198.js";import{E as o}from"./Example-d2e66356.js";const h=()=>t("div",{children:[e("h1",{children:"Inputs"}),e("p",{children:"This section of the documentation provides detailed information about different input types."}),e(m,{menu:n})]}),p=`import { Form, Field } from '../../../../../lib/index.js'
...
export default Text`,u=()=>t(l,{children:[e(a,{name:"one"}),e(a,{name:"two",label:"A text input with a label"}),e(a,{name:"three",label:"Another text input",type:"text"}),e(a,{name:"four",label:"Text with placeholder",placeholder:"Hello World!"}),e(a,{name:"money",label:"Prefix/Suffix",prefix:"$",suffix:".00"})]}),f=`import { Form, Field } from '../../../../../lib/index.js'
...
export default RadioWide`,P=()=>e(l,{children:e(a,{name:"food",label:"What is your favourite number?",type:"radio",options:[{value:10,text:"Ten"},{value:11,text:"Eleven (one louder)",className:"bold"},{value:42,text:t(c,{children:["Forty-Two (the meaning of ",e("i",{children:"life"}),")"]})}],className:"wide"})}),H=`import { Form, Field } from '../../../../../lib/index.js'
