...
export default PictureInput`,W=`import badgerUrl from '/badger.jpg'
...
export default Picture`,$=`div.animals {
  display: flex;
  gap: 1rem;
}
div.animal {
...
div.animal.selected {
  border-color: #88f;
}`,y=({uri:t})=>e(S,{uri:t,menu:p}),D=()=>n("div",{children:[e("h1",{children:"Custom Input"}),e("p",{className:"intro",children:"You can define your own components to handle the input for a field."}),n("p",{children:["The ",e(w,{})," property can be set on a field to contain a custom component for rendering the field input.  In this example we define a ",e("code",{children:"PictureInput"})," component to show some pictures of animals for the user to select an animal guide from."]}),e(f,{Element:U,code:_,caption:"Picture Form",expand:!0,children:e("p",{children:"Click on an animal to select it.  In this example we're just implementing a custom input and relying on the default field layout to provide us with the label and validation message.  Try submitting the form without selecting an animal to see the validation error message in effect."})}),n("p",{children:["Here's the implementation of the ",e("code",{children:"PictureInput"})," component."]}),e(l,{code:c(A),caption:"PictureInput",expand:!0}),n("p",{children:["On line 7 we call ",e("code",{children:"useField()"})," to get the current field"," ",e("code",{children:"value"})," and the ",e("code",{children:"onChange"})," function to set the value.  We iterate over a list of animals on line 10 and render the"," ",e("code",{children:"Picture"})," component for each.  We pass the ",e("code",{children:"selected"})," ","flag on line 15 to indicate if the animal name matches the current"," ",e("code",{children:"value"}),".  We also pass a ",e("code",{children:"select"})," ","function on line 16 which calls the ",e("code",{children:"onChange"})," handler to select the animal."]}),n("p",{children:["Here's the ",e("code",{children:"Picture"})," component."]}),e(l,{code:c(W),caption:"Picture",expand:!0}),e("p",{children:"For completeness, here's the additional CSS we're using to apply the styling."}),e(l,{code:$,caption:"animals.css",language:"css",expand:!0}),e("h2",{className:"hint",children:"Picture Credits"}),n("ul",{className:"credits",children:[n("li",{children:["Badger photo by ",e("a",{href:"https://unsplash.com/es/@vincentvanzalinge?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText",children:"Vincent van Zalinge"})," on ",e("a",{href:"https://unsplash.com/photos/jd8s5zhWEug?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText",children:"Unsplash"})]}),n("li",{children:["Gorilla photo by ",e("a",{href:"https://unsplash.com/@kellysikkema?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText",children:"Kelly Sikkema"})," on ",e("a",{href:"https://unsplash.com/images/animals/monkey?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText",children:"Unsplash"})]}),n("li",{children:["Kitten photo by ",e("a",{href:"https://unsplash.com/@feneek?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText",children:"Sergey Semin"})," on ",e("a",{href:"https://unsplash.com/images/animals/kitten?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText",children:"Unsplash"})]})]}),e(y,{uri:"input"})]}),H=({id:t,topping:o,selected:i,select:r})=>e("div",{children:n("label",{htmlFor:t,className:"option",children:[e("input",{className:"input",type:"checkbox",checked:i,onChange:r,id:t}),e("span",{className:"text",children:o})]})}),q=({id:t,toppings:o,selected:i,select:r})=>e("div",{className:"options",children:o.map(a=>e(H,{topping:a,id:`${t}-${a}`,selected:i[a]||!1,select:()=>r(a)},a))}),B=({value:t,free:o,price:i})=>e("div",{className:"summary",children:t.map((r,a)=>n("div",{className:"selected",children:[e("div",{children:r}),e("div",{children:a<o?"Free":i})]},r))}),M=t=>t.reduce((o,i)=>(o[i]=!0,o),{}),Y=(t,o)=>i=>{t[i]=!t[i],o(Object.entries(t).filter(r=>r[1]).map(r=>r[0]))},G=()=>{const{id:t,value:o,onChange:i,free:r,price:a,toppings:v}=m(),d=M(o),b=Y(d,i);return n("div",{className:"toppings field",children:[e("p",{children:"Select any extra toppings you want on your pizza."}),n("p",{className:"pricing",children:["The first ",r," are free. Any additional toppings are ",e("span",{className:"price",children:a})," each."]}),e(T,{}),n("div",{className:"selection",children:[e(q,{id:t,toppings:v,value:o,selected:d,select:b}),e(B,{value:o,free:r,price:a})]})]})};const K={toppings:{Layout:G,label:"Pick your toppings",default:[],free:3,price:"£1.00",toppings:["Ham","Bacon","Onions","Sausage","Pepperoni","Mushrooms","Sweetcorn","Pineapple","Extra Cheese"]}},Q=()=>n(u,{fields:K,children:[e(h,{name:"toppings"}),e(g,{})]}),V=`import { Form, Field, ResetSubmit } from '../../../../../lib/index.js'
